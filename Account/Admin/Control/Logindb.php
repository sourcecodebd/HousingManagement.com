...
$result = $conn->query("SELECT * FROM ". $table." WHERE id='". $id."'");
 ...
 function ShowAll($conn,$table,$id) {
    ...
    function UpdateAdmin($conn,$table,$un,$fname,$lname,$password,$email,$gender,$profession,$date,$file,$file_path)
    {
        $sql = "update admins SET firstname='$fname',lastname='$lname',password='$password', email='$email',gender='$gender',profession='$profession',date='$date',file='$file',file_path='$file_path' WHERE username='$un'";
