...
session_start();
$flatname= $flataddress= $price= $flatstatus= $aboutflat= $dateoflaunching= $owner=$buyer= $error="";
...
$userQuery=$connection->UpdateOwnerSell($conobj,"userbuy",$_SESSION['id'],$_POST['flatname'],$_POST['flataddress'],$_POST['price'],$_POST['flatstatus'],$_POST['aboutflat'],$_POST['dateoflaunching'],$_POST['owner'],$_POST['buyer']);
