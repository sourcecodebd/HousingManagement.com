...
include('../Control/OwnerBargaincheck.php');
...
<html>
<head>
<title>ADMIN PANEL | Owner Bargaining Details</title>
...
<a href="OwnerBargain.php">REFRESH</a>
...
<div id="ProfileBlock3">
<h1 id="Title">Owner Bargaining Details</h1>
</div>

<div id="ProfileBlock4">

<h2 id="Hi">Hi! </h2> <h2 id="Username"><?php echo  $_SESSION["un"]; ?><br><h3 id="YourProfile">Update Owner Bargaining Details</h3></h2>
<b>
...
if ($userQuery->num_rows > 0) {
    ...
    while($row = $userQuery->fetch_assoc()) {
      ...
      echo "<h3 id='fname'>Bargain Price [Owner]: <input type='text' name='ownerbargain' value=".$row["bargainbyowner"]." >$error</h3> <br>";
      echo "<h3 id='fname'>Bargain Price [User]: <input type='text' name='userbargain' value=".$row["bargainbyuser"]." readonly>$error</h3> <br>";
      echo "<h3 id='gender'>Agree to Sell? <br><input type='radio' name='ownerbargainstatus' value= 'Yes' checked ><span id='Male' >Yes</span></h3>";
      echo "<h3 id='gender'> <input type='radio' name='ownerbargainstatus' value= 'No' ><span id='Female'>No</span></h3> <br>";
      echo "<h3 id='date'>Date of Bargaining: <input type='date' name='bargaindate' value=".$row["dateofbargaining"]." ></h3><br>";
