...
include('../Control/UserUpdatecheck.php');
include('../Control/UserDeletecheck.php');
...
<html>
<head>
<title>ADMIN PANEL | User Profile Details</title>
...
<a href="UserProfile.php">REFRESH</a>
...
<h2 id="Hi">Hi! </h2> <h2 id="Username"><?php echo  $_SESSION["un"]; ?><br><h3 id="YourProfile">Update User Profile</h3></h2>
<b>
...
$userQuery=$connection->InputCheckUser($conobj,"users",$id);
...
<?php
  ...
  echo "<h2 id='UserList'>User Profile Details is here...</h2>";
  $connection = new Logindb();
$conobj=$connection->OpenCon();
$userQuery=$connection->FetchCheckUser($conobj,"users");
