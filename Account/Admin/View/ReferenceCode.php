...
<html>
<head>
<title>ADMIN PANEL | Reference Code</title>
...
<script src="../../../JS/ReferenceValidation.js"></script>
...
<a href="Account.php">ADMIN PANEL</a>
...
include('../Control/ReferenceCodecheck.php');
...
<div id="LoginBlock4">
<h1 id="Title">Reference Code</h1>
</div>
<b>
<div id="LoginBlock5">
<h2 id="Marquee"><marquee>Enter Reference Code to apply for Admin post now!</marquee></h2>
</div>
<div id="LoginBlock6">
<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method='post' onsubmit="return validateForm()">
  <Label>Reference Code:</label><br> <?php echo $error;?> <h4 id="jsnameerror"></h4>
