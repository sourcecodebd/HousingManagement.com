...
<html>
<head>
<title>FLAT RENTER | Profile</title>
...
$userQuery=$connection->CheckRenter($conobj,"users",$_SESSION["un"]);
...
<input name="radio" type="checkbox" id="customize_1" onClick="RadioToggleTables('1')" value="radio" disabled checked />Flat Renter 
